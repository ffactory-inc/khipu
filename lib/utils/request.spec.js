...
const postReqOptions = {
  ...
  headers: {
    ...
    'User-Agent': 'node-client',
    Authorization:
      '313980:d78649314f7758db6298a091fadae0dc26cb37f3d745fc2d383523fd7fa883b1',
  },
};

jest.mock('https');
describe('HTTPS api requets ', () => {
  it('should return a validation exception, because the request options are empty', async () => {
    try {
